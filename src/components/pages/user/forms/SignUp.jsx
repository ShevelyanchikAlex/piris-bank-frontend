...
const SignUp = () => {
    ...
    return (
        <div>
            <h1 style={{marginTop: '6%', textAlign: "center"}}>Sign Up</h1>
            {isLoading ? <CircularProgress style={{marginLeft: '50%', marginRight: '50%', marginTop: '10%'}}/> :
                <Card align={"center"}
                    ...
                    <form onSubmit={formik.handleSubmit} style={{margin: 10}} noValidate>
                            ...
                            <Box sx={{margin: 'auto'}} style={{minWidth: 200, display: 'grid'}}>
                                ...
                                <FormControl sx={{m: 1}}>
                                    ...
                                    <RadioGroup
                                        ...
                                        name="isPensioner"
                                        defaultValue={isPensionerValues.at(0)}
                                    >
                                        {
                            ...
                            {formik.values.gender && formik.values.gender === genders.at(0) &&
                                <FormControl sx={{m: 'auto'}}>
                                    ...
                                    <RadioGroup
                                        ...
                                        name="isReservist"
                                        defaultValue={isReservistValues.at(0)}
                                    >
                                        {
                        ...
                        <Button
                            variant='contained'
                            style={{margin: 10, borderRadius: 5, background: '#2196f3'}}
                            type="submit"
